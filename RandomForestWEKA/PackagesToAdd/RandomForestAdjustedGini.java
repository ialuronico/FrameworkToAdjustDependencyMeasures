...
import weka.classifiers.meta.Subagging;
 ...
 */
public class RandomForestAdjustedGini extends AbstractClassifier implements OptionHandler,
  Randomizable, WeightedInstancesHandler, AdditionalMeasureProducer,
  TechnicalInformationHandler, PartitionGenerator, Aggregateable<RandomForestAdjustedGini> {
   ...
   */
  public static final Tag [] TAGS_SPLITCRIT = RandomTreeAdjustedGini.TAGS_SPLITCRIT;
  
  /** It uses the same split criteria as 
   * Random tree. The default criterion 
   * is Info gain 
  */
  public static final int SPLITCRIT_DEFAULT = RandomTreeAdjustedGini.SPLITCRIT_DEFAULT;
  public static final int SPLITCRIT_Gini = RandomTreeAdjustedGini.SPLITCRIT_Gini;
  public static final int SPLITCRIT_SGini = RandomTreeAdjustedGini.SPLITCRIT_SGini;
  public static final int SPLITCRIT_AGiniAlpha = RandomTreeAdjustedGini.SPLITCRIT_AGiniAlpha;
  ...
  // Because I want no replacement
  protected Subagging m_bagger = null;
  ...
  protected boolean m_dontCalculateOutOfBagError = true;
  ...
  public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(new Option(
  			"\tSplitting criterion.\n" +
  			"\t(Default = Info gain as Weka Random Forests))",
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    // Bagging with no replacement - Subagging
    m_bagger = new Subagging();
    ...
    RandomTreeAdjustedGini rTree = new RandomTreeAdjustedGini();
    ...
    // This is related to subagging
    // Select with no replacement 50 percent of the instances (can be 63 to simulate bagging)
    m_bagger.setBagSizePercent(50);
    // Switch off the computation of error (even if it could be implemented)
    m_bagger.setCalcOutOfBag(false);
    this.setDontCalculateOutOfBagError(true);    
  ...
  public static void main(String[] argv) {
    runClassifier(new RandomForestAdjustedGini(), argv);
  }

  @Override
  public RandomForestAdjustedGini aggregate(RandomForestAdjustedGini toAggregate) throws Exception {
