...
title(['MIC, $n = ' num2str(notMiss) '$'],'Interpreter','Latex','FontSize',fsl);
...
title(['AMIC, $n = ' num2str(notMiss) '$'],'Interpreter','Latex','FontSize',fsl);
namex = strrep(names(jp),'_',' ');
namex = strrep(namex, '%', '\%');
xlabel(filterName(namex{1}),'Interpreter','Latex','FontSize',fsl);
ylim([minY maxY]);
...
title(['SMIC, $n = ' num2str(notMiss) '$'],'Interpreter','Latex','FontSize',fsl);
namex = strrep(names(jp),'_',' ');
namex = strrep(namex, '%', '\%');
xlabel(filterName(namex{1}),'Interpreter','Latex','FontSize',fsl);
ylim([minY maxY]);
...
title(['$\mbox{AMIC}( \alpha =' num2str(a) ')$, $n = ' num2str(notMiss) '$'],'Interpreter','Latex','FontSize',fsl);
namex = strrep(names(jp),'_',' ');
namex = strrep(namex, '%', '\%');
xlabel(filterName(namex{1}),'Interpreter','Latex','FontSize',fsl);
ylim([minY maxY]);
